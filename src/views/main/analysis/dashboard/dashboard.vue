<template>
  <div class="dashboard">
    ...
    <el-row :gutter="10">
      <el-col :span="7">
        <chart-card :header="header.pieEchart">
          <pie-echart :pie-data="showGoodsCategoryCount" />
        </chart-card>
      </el-col>
      <el-col :span="10">
        <chart-card :header="header.mapEchart">
          <map-echart :map-data="showGoodsAddressSale" />
        </chart-card>
      </el-col>
      <el-col :span="7">
        <chart-card :header="header.roseEchart">
    ...
    <el-row :gutter="10">
      <el-col :span="12">
        <chart-card :header="header.lineEchart">
          <line-echart v-bind="showGoodsCategorySale" />
        </chart-card>
      </el-col>
      <el-col :span="12">
        <chart-card :header="header.barEchart">
...
// console.log(showGoodsAddressSale)
// console.log('showGoodsCategoryFavor', showGoodsCategoryFavor)
</script>
